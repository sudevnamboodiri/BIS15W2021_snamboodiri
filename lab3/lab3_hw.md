...
```
## Small animals sleep for an average of 12.65833 hours and big animals sleep for an average of 3.3 hours
```

```r
print('So smaller animals sleep longer')
```

```
## [1] "So smaller animals sleep longer"
```
